...
--
-- Database: `composite_behavioral_modeling`
--
CREATE DATABASE IF NOT EXISTS `composite_behavioral_modeling` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `composite_behavioral_modeling`;
...
(1, 'Amaresh', 'Amaresh123@gmail.com', 'Amaresh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Vijayanagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Block,Vijayanagar', 'Male');
...
(24, 'Extra Tree Classifier', '52.468265162200275'),
(25, 'SVM', '54.30183356840621'),
(26, 'Logistic Regression', '54.160789844851905'),
(27, 'Gradient Boosting Classifier', '55.99435825105783');
...
(10, 'No Theft or Fraud Found', '50.0'),
(11, 'Theft or Fraud Found', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_identity_theft_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_identity_theft_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Account_Id` varchar(300) NOT NULL,
  `Trans_Id` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Followers` varchar(300) NOT NULL,
  `NAME_CONTRACT_TYPE` varchar(300) NOT NULL,
  `GENDER` varchar(300) NOT NULL,
  `AMT_INCOME_TOTAL` varchar(300) NOT NULL,
  `AMT_CREDIT` varchar(300) NOT NULL,
  `AMT_ANNUITY` varchar(300) NOT NULL,
  `AMT_GOODS_PRICE` varchar(300) NOT NULL,
  `NAME_INCOME_TYPE` varchar(300) NOT NULL,
  `NAME_FAMILY_STATUS` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_identity_theft_detection`
--

INSERT INTO `remote_user_identity_theft_detection` (`id`, `Account_Id`, `Trans_Id`, `Age`, `Followers`, `NAME_CONTRACT_TYPE`, `GENDER`, `AMT_INCOME_TOTAL`, `AMT_CREDIT`, `AMT_ANNUITY`, `AMT_GOODS_PRICE`, `NAME_INCOME_TYPE`, `NAME_FAMILY_STATUS`, `Prediction`) VALUES
(1, '172.217.10.234-10.42.0.151-443-40023-6', '100006', '39', '1260', 'Cash loans', 'F', '135000', '312682.5', '29686.5', '297000', 'Working', 'Civil marriage', 'No Theft or Fraud Found'),
(2, '10.42.0.42-121.12.98.63-52319-80-6', '100008', '31', '1270', 'Cash loans', 'M', '99000', '490495.5', '27517.5', '454500', 'State servant', 'Married', 'Theft or Fraud Found'),
(3, '10.42.0.211-10.42.0.1-7624-53-17', '100022', '34', '600', 'Revolving loans', 'F', '112500', '157500', '7875', '157500', 'Working', 'Widow', 'No Theft or Fraud Found'),
(4, '151.101.1.140-10.42.0.151-443-40609-6', '100264', '50', '1902', 'Cash loans', 'F', '121500', '1215000', '48186', '1215000', 'Pensioner', 'Married', 'Theft or Fraud Found');
